    ...
    <div className="flex-1 p-4 flex flex-col gap-4">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h1 className="text-xl font-semibold">
            Manage Schedule - {student.name} {student.surname}
          </h1>
          <p className="text-sm text-gray-500">
            Weekly schedule for this student&apos;s login homepage
            {student.class ? ` (${student.class.name})` : ""}
          </p>
        </div>
        <span className="text-sm text-gray-500">
          {student.schedules.length} schedule items
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1fr)_460px]">
        ...
        <div className="bg-white p-4 rounded-md">
          ...
          <form
            action={createStudentScheduleItem}
            ...
            <div className="mt-4 flex flex-col gap-3">
              {student.schedules.length === 0 ? (
                <p className="text-sm text-gray-400">
                  No weekly schedule items have been added for this student yet.
                </p>
              ) : (
                student.schedules.map((item) => (
                  ...
                  >
                    ...
                    <form
                      action={updateStudentScheduleItem}
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          form={`delete-schedule-item-${item.id}`}
                    ...
                    <form
                      id={`delete-schedule-item-${item.id}`}
                      action={deleteStudentScheduleItem}
                    >
                      <input type="hidden" name="id" value={item.id} />
                      <input
                        type="hidden"
