...
const AssignmentListPage = async ({
  ...
  if (queryParams) {
    for (const [key, value] of Object.entries(queryParams)) {
      if (value !== undefined) {
        switch (key) {
          case "classId":
            query.lesson.classId = getNumberParam(value);
            break;
          case "teacherId":
            query.lesson.teacherId = value;
            break;
          case "subjectId":
            query.lesson.subjectId = getNumberParam(value);
            break;
          case "search":
            query.OR = [
  ...
  const orderByOptions: Record<string, Prisma.AssignmentOrderByWithRelationInput> = {
    title: { title: sortDirection },
    startDate: { startDate: sortDirection },
    dueDate: { dueDate: sortDirection },
  };
  const orderBy =
    orderByOptions[searchParams.sort || "dueDate"] || orderByOptions.dueDate;
